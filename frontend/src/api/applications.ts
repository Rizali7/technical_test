...
// Example instance of BrokerApplicationsPostDto
const examplePayload: BrokerApplicationsPostDto = {
  // populate with appropriate fields and values based on the structure of BrokerApplicationsPostDto
};

console.log("BrokerApplicationsPostDto", examplePayload);
export default {
